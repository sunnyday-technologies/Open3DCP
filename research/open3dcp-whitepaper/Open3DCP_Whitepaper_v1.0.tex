...
hardened-strength columns and ingests at a fidelity of \textbf{98.8/100
...
\item
  Add the \textbf{3DCP-native structural columns} the relational
  crosswalk surfaces as gaps rather than dead ends: a reinforcement
  block beyond fibers (penetrating bar, entrained cable, inter-layer
  mesh/textile) and embedded-sensor / in-situ print-monitoring
  references --- additive and backward-compatible.
\end{enumerate}
